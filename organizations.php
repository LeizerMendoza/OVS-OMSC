...
<head>
  ...
  <title>Organizations | OMSC Elections</title>
...
<script>
  ...
  <main class="flex-grow flex items-center justify-center px-6 mt-24">
    <div class="bg-white bg-opacity-95 p-10 rounded-lg shadow-xl w-full max-w-3xl text-center">
      <h2 class="text-2xl font-bold text-[#0D1B2A] mb-6">Select an Organization</h2>
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">

        <a href="../student/vote.php?election_type=PADC" class="bg-[#0D1B2A] text-white py-4 px-6 rounded-md shadow hover:bg-purple-600 transition">PADC</a>

        <a href="../student/vote.php?election_type=YMO" class="bg-[#0D1B2A] text-white py-4 px-6 rounded-md shadow hover:bg-blue-600 transition">YMO</a>

        <a href="../student/vote.php?election_type=YES" class="bg-[#0D1B2A] text-white py-4 px-6 rounded-md shadow hover:bg-yellow-400 transition">YES</a>
      </div>
    </div>
  </main>
